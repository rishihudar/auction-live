        ...
        <template #empty>
                ...
                <Column header="Action">   
                    <template #body="slotProps">
                        <Button severity="secondary" @click="fetchAuctionBidderDetails(slotProps.data)">
                             Details
                        </Button> 
                    </template>                  
                </Column>
    ...
    new MQL()
        ...
        .then(rs => {
            ...
            if (rs.isValid("FetchCancelledAuctionBidderDetails")) {
                ...
                console.log("Printing from FetchCancelledAuctionBidderDetails: ", auctionBidderDetails.value)
