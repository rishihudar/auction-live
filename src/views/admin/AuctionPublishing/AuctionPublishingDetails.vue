                ...
                <template #expansion="slot">
                    <div class="box-section">
                        <div class="bs-header">
                            Auction Description
                            <div class="bs-action">
                                <Button severity="secondary" class="btn-sm"  @click="viewPublishDetails(slot.data.auctionCode),fetchAllStepsAuctionPreview(),visible = true">
                                ...
                                <Dialog
                                    ...
                                    :style="{ width: '60rem' }"
                                >
                                    <div class="modal-subtitle">Auction Code: <span> {{ auctionId }}</span> </div>
                                    <div class="form-grid">
                                        <div class="col-span-full md:col-span-6">
                                            <div class="fm-group">
                                                <label class="fm-label" for="Processing Fee">Processing Fee And EMD payment Start Date:</label>                                            
                                                <div class="fm-inner">
                                                    <Calendar
                                                    id="calendar-24h"
