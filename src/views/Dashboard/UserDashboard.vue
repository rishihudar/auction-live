<template>
  <div>
    <div class="stat-area stat-area-alt">
        <div class="card-wrapper" v-for="(card, index) in cards" :key="index"  @click="navigateToAbout">
          <div class="card card-stat card-stat-alt"  v-if="userRole==card.roleId">
            <div class="card-body">
...
const publishAuctionsCount = ref(0);
...
function fetchDashboardDetails() {
  new MQL()
    ...
    .setData({userRoleId:userRole.value,
