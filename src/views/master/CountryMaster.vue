...
<template v-if="flag===0">
    <div class="card">
        ...
        filterDisplay="row" 
        :loading="loading" 
        :globalFilterFields="['pklCountryId', 'vsCountryName', 'vsCountryCode', 'vsCountryShortName', 'vsCountryTelephoneCode', 'vsNationality']">
            ...
            <Column field="vsCountryName" header="Country Name" style="min-width: 12rem">
                <template #body="{ data }">
                    {{ data.vsCountryName }}
                </template>
            ...
            <Column field="vsCountryShortName" header="Country Short Name" style="min-width: 12rem">
                <template #body="{ data }">
                    {{ data.vsCountryShortName }}
                </template>
                <template #filter="{ filterModel, filterCallback }">
                    <InputText v-model="filterModel.value" @input="filterCallback()" class="p-column-filter"
            ...
            <Column field="vsCountryTelephoneCode" header="Country Telephone Code" style="min-width: 12rem">
                <template #body="{ data }">
                    {{ data.vsCountryTelephoneCode }}
                </template>
                <template #filter="{ filterModel, filterCallback }">
                    <InputText v-model="filterModel.value" @input="filterCallback()" class="p-column-filter"
            ...
            <Column field="vsNationality" header="Nationality" style="min-width: 12rem">
                <template #body="{ data }">
                    {{ data.vsNationality }}
                </template>
                <template #filter="{ filterModel, filterCallback }">
...
export default {
    ...
    setup() {
        ...
        const filters = ref({
            ...
            vsNationality: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
            vsCountryTelephoneCode: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
            vsCountryShortName: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
            vsCountryName: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
