...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: {
        title: "OrganizationAdminComponent",
        lang: "en",
        icon: "mdi mdi-home-outline",
        roles: ["ROLE_MAKER", "ROLE_CHECKER", "ROLE_APPROVER"],
      },
    ...
    },
    {
      ...
      meta: {
        title: "MISRegistrationFeeReport",
        lang: "en",
        icon: "mdi mdi-home-outline",
        roles: ["ROLE_SUPERADMIN"],
      },
